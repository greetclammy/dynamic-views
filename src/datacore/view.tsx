...
export function View({
  ...
  const propertySettingsKey = [
    ...
    settings.propertySet1PositionOnTop,
    settings.propertySet2PositionOnTop,
    settings.propertySet3PositionOnTop,
    settings.propertySet4PositionOnTop,
    settings.propertySet5PositionOnTop,
    settings.propertySet6PositionOnTop,
    settings.propertySet7PositionOnTop,
