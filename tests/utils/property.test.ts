...
describe('property', () => {
  describe('getFirstBasesPropertyValue', () => {
    ...
    it('should try formula prefix if property not found', () => {
      ...
      const result = getFirstBasesPropertyValue(mockApp, mockEntry, 'customProp');
    ...
    it('should return null when no properties have values', () => {
      ...
      const result = getFirstBasesPropertyValue(mockApp, mockEntry, 'prop1, prop2, prop3');
  ...
  describe('getFirstBasesDatePropertyValue', () => {
    ...
    it('should return first date property', () => {
      ...
      const result = getFirstBasesDatePropertyValue(mockApp, mockEntry, 'prop1, prop2');
  ...
  describe('getFirstDatacoreDatePropertyValue', () => {
    ...
    it('should return DateTime objects with toMillis method', () => {
      ...
      const result = getFirstDatacoreDatePropertyValue(mockPage, 'prop1, prop2');
  ...
  describe('getAllBasesImagePropertyValues', () => {
    ...
    it('should collect array values', () => {
      ...
      const result = getAllBasesImagePropertyValues(mockApp, mockEntry, 'images');
    ...
    it('should collect from multiple properties', () => {
      ...
      const result = getAllBasesImagePropertyValues(mockApp, mockEntry, 'prop1, prop2');
    ...
    it('should skip null/empty values', () => {
      ...
      const result = getAllBasesImagePropertyValues(mockApp, mockEntry, 'a, b, c');
    ...
    it('should handle mixed arrays', () => {
      ...
      const result = getAllBasesImagePropertyValues(mockApp, mockEntry, 'mixed');
  ...
  describe('getAllDatacoreImagePropertyValues', () => {
    ...
    it('should handle arrays of Link objects', () => {
      mockPage.value = jest.fn().mockReturnValue([
        { path: 'img1.png' },
        { path: 'img2.png' },
      ]);
  ...
  describe('getAllVaultProperties', () => {
    ...
    it('should get properties from metadata cache if available', () => {
      (mockApp.metadataCache as any).getAllPropertyInfos = jest.fn().mockReturnValue({
        customProp1: {},
        customProp2: {},
        title: {},
      });
