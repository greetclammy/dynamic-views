import { shuffleArray, getActiveBasesView, getActiveDynamicViewsBase, openRandomFile, toggleShuffleActiveView } from '../../src/utils/randomize';
...
describe('randomize', () => {
  ...
  describe('getActiveBasesView', () => {
    ...
    it('should return null when no active leaf', () => {
      mockApp.workspace.activeLeaf = null as any;
    ...
    it('should return null when active view is not a Bases view', () => {
      ...
      mockApp.workspace.activeLeaf = mockLeaf as any;
  ...
  describe('openRandomFile', () => {
    ...
    it('should open random file from entries', async () => {
      ...
      const calledPath = (mockApp.workspace.openLinkText as jest.Mock).mock.calls[0][0];
    ...
    it('should respect openInNewPane parameter', async () => {
      ...
      expect(mockApp.workspace.openLinkText).toHaveBeenCalledWith('file.md', '', true);
    });
